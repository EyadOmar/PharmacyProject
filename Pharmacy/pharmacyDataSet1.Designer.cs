...
namespace Pharmacy {
    ...
    public partial class pharmacyDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ordersDataTable : global::System.Data.TypedTableBase<ordersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ordersRow AddordersRow(int order_id, medicinesRow parentmedicinesRowByFK__orders__medicine__534D60F1, clientsRow parentclientsRowByFK__orders__client_i__5441852A, System.DateTime oreder_date, int quantity) {
...
SELECT client_ID, client_Name, client_Phone, client_Address FROM clients WHERE (client_ID = @client_ID)";
        ...
        public virtual int Fill(pharmacyDataSet1.clientsDataTable dataTable) {
        ...
        public virtual pharmacyDataSet1.clientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            pharmacyDataSet1.clientsDataTable dataTable = new pharmacyDataSet1.clientsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(pharmacyDataSet1.clientsDataTable dataTable) {
...
SELECT medicine_id, medicin_name, production_date, expired_date, medicine_price, medicine_location, stock, supplier_id FROM medicines WHERE (medicine_id = @medicine_id)";
    ...
    public partial class ordersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[orders] WHERE (([order_id] = @Original_order_id) AND ([medicine_id] = @Original_medicine_id) AND ([client_id] = @Original_client_id) AND ([oreder_date] = @Original_oreder_date) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[orders] ([order_id], [medicine_id], [client_id], [oreder_date], [quantity]) VALUES (@order_id, @medicine_id, @client_id, @oreder_date, @quantity);
SELECT order_id, medicine_id, client_id, oreder_date, quantity FROM orders WHERE (order_id = @order_id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[orders] SET [order_id] = @order_id, [medicine_id] = @medicine_id, [client_id] = @client_id, [oreder_date] = @oreder_date, [quantity] = @quantity WHERE (([order_id] = @Original_order_id) AND ([medicine_id] = @Original_medicine_id) AND ([client_id] = @Original_client_id) AND ([oreder_date] = @Original_oreder_date) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)));
SELECT order_id, medicine_id, client_id, oreder_date, quantity FROM orders WHERE (order_id = @order_id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT order_id, medicine_id, client_id, oreder_date, quantity FROM dbo.orders";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(pharmacyDataSet1.ordersDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_order_id, int Original_medicine_id, int Original_client_id, System.DateTime Original_oreder_date, global::System.Nullable<int> Original_quantity) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int order_id, int medicine_id, int client_id, System.DateTime oreder_date, global::System.Nullable<int> quantity) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int order_id, int medicine_id, int client_id, System.DateTime oreder_date, global::System.Nullable<int> quantity, int Original_order_id, int Original_medicine_id, int Original_client_id, System.DateTime Original_oreder_date, global::System.Nullable<int> Original_quantity) {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((System.DateTime)(Original_oreder_date));
            if ((Original_quantity.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int medicine_id, int client_id, System.DateTime oreder_date, global::System.Nullable<int> quantity, int Original_order_id, int Original_medicine_id, int Original_client_id, System.DateTime Original_oreder_date, global::System.Nullable<int> Original_quantity) {
            return this.Update(Original_order_id, medicine_id, client_id, oreder_date, quantity, Original_order_id, Original_medicine_id, Original_client_id, Original_oreder_date, Original_quantity);
        }
    }
